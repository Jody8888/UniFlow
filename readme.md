...
| - [][Backend]AI processor | Forwarding notification fetched to AI for structuralized results. | [PENDING] | [PENDIND] |
| - [][Backend]Notification database | Hosting notification info for clients to fetch. | [PENDING] | [PENDING] |
| - [][Frontend]Android frontend | Calender and todo feature | [PENDING] | [PENDING] |
| - [][Frontend]Ios frontend | Calender and todo feature | [PENDING] | [PENDING] |
| - [][Frontend & Backend]Feed management site| Administrate the fetch&feed stream | [PENDING] | [PENDING] |
## Domains of interest And how to deal with them [doi.md](./doi.md)
